...
# import src.rocrateValidator.utils as utils
# import src.rocrateValidator.semanticCheck as semanticCheck
# import src.rocrateValidator.syntaxCheck as syntaxCheck
...
class TestBase:
    ...
    def licensing_example1(self):
        return utils.Result(NAME = "Licensing property check", code = -1, message = "Invalid ID Value at https://spdx.org/licenses/CC-BY-NC-SA-4.0. It must be an URL.")
