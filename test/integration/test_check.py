...
sample_valid_1 = "test/samples/valid"
sample_invalid_missing_root = "test/samples/invalid/brroken_example"
sample_invalid_referencing_missing = "test/samples/invalid/referencing_missing"
sample_invalid_context_missing = "test/samples/invalid/context_missing"
sample_invalid_json = "test/samples/invalid/invalid_json"
sample_invalid_metadataFile_missing = "test/samples/invalid/metadataFile_missing"
sample_invalid_descriptorType = "test/samples/invalid/invalid_descriptorType"
# FIXME: Not used??
#sample_invalid_metadataFile = "test/samples/invalid/empty_metadataFile"
sample_invalid_encodingType_1 = "test/samples/invalid/invalid_encodingType1"
sample_invalid_encodingType_2 = "test/samples/invalid/invalid_encodingType2"
sample_invalid_id = "test/samples/invalid/invalid_directProp_id"
sample_invalid_person_type = "test/samples/invalid/invalid_personEntity_type"
sample_invalid_type = "test/samples/invalid/invalid_directProp_type"
sample_invalid_licenceType = "test/samples/invalid/invalid_licenseType"
sample_invalid_dateFormat = "test/samples/invalid/invalid_directProp_dateFormat"
sample_invalid_webBasedPublishedDate = "test/samples/invalid/webBasedEntity_publishedDateMissing"
sample_invalid_webBasedEntityType = "test/samples/invalid/invalid_webBasedEntity_type"
sample_invalid_webBasedEntityId = "test/samples/invalid/invalid_webBasedEntity_id"
sample_invalid_contactInfo = "test/samples/invalid/invalid_contactInfo_type"
sample_invalid_citation_missing = "test/samples/invalid/citation_referencingMissing"
sample_invalid_organizationType = "test/samples/invalid/invalid_organizationType"
sample_invalid_citationId = "test/samples/invalid/invalid_citationId"
sample_invalid_publisher_referencing = "test/samples/invalid/publisher_referencingMissing"
...
class TestGroup(DataBase):
    ...
    def test_file_existence(self, existence_true):
        result = syntaxCheck.existence_check(sample_invalid_referencing_missing, extension)
        outcome = self.check_result(result, existence_true)

        assert outcome == True

    def test_file_existence_1(self, existence_false_1):
        result = syntaxCheck.existence_check(sample_invalid_missing_root, extension)
        outcome = self.check_result(result, existence_false_1)

        assert outcome == True

    def test_file_size_0(self):
        v = validate.validate(sample_invalid_missing_root)
    ...
    def test_file_size(self, fileSize_true):
        result = syntaxCheck.file_size_check(sample_invalid_referencing_missing, extension)
        outcome = self.check_result(result, fileSize_true)

        assert outcome == True

    # def test_file_size_1(self, fileSize_false):
    #     result = syntaxCheck.file_size_check(sample_invalid_dateFormat, extension)
    #     outcome = self.check_result(result, fileSize_false)

    #     assert outcome == True

    def test_metadataFile(self, metadata_true):
        result = syntaxCheck.metadata_check(sample_invalid_referencing_missing, extension)
        outcome = self.check_result(result, metadata_true)

        assert outcome == True

    def test_metadataFile_1(self, metadata_false_1):
        result = syntaxCheck.metadata_check(sample_invalid_metadataFile_missing, extension)
        outcome = self.check_result(result, metadata_false_1)

        assert outcome == True

    def test_metadataFile_2(self, metadata_true):
        result = syntaxCheck.metadata_check(sample_invalid_context_missing, extension)
        outcome = self.check_result(result, metadata_true)
    ...
    def test_rdf(self, rdf_true):
        result =shexCheck.rdf_parse_check(sample_valid_1, extension)
        outcome = self.check_result(result, rdf_true)
        assert outcome == True

    def test_rdf_1(self, rdf_json_error):
        result =shexCheck.rdf_parse_check(sample_invalid_json, extension)
    ...
    def test_json(self, json_true):
        result =syntaxCheck.string_value_check(sample_invalid_referencing_missing, extension)
        outcome = self.check_result(result, json_true)
        assert outcome == True

    def test_json_1(self, json_true):
        result =syntaxCheck.string_value_check(sample_invalid_context_missing, extension)
        outcome = self.check_result(result, json_true)

        assert outcome == True

    def test_json_2(self, json_false_1):
        result =syntaxCheck.string_value_check(sample_invalid_json, extension)
    ...
    def test_jsonld(self, context_true):
        result = syntaxCheck.check_context(sample_invalid_referencing_missing, extension)
        outcome = self.check_result(result, context_true)

        assert outcome == True

    def test_jsonld_1(self, context_false):
        result = syntaxCheck.check_context(sample_invalid_context_missing, extension)
    ...
    def test_descriptor(self, descriptor_true):
        result = semanticCheck.file_descriptor_check(sample_invalid_referencing_missing, extension)
        outcome = self.check_result(result, descriptor_true)

        assert outcome == True

    def test_descriptor_1(self, descriptor_false):
        result = semanticCheck.file_descriptor_check(sample_invalid_descriptorType, extension)
    ...
    def test_referencing(self, referencing_referencingError_1):
        result = semanticCheck.referencing_check(sample_invalid_referencing_missing, extension)
        outcome = self.check_result(result, referencing_referencingError_1)

        assert outcome == True

    def test_referencing_1(self, referencing_true):
        result = semanticCheck.referencing_check(sample_valid_1, extension)
    ...
    def test_encoding(self, encoding_true):
        result = semanticCheck.encoding_check(sample_invalid_referencing_missing, extension)
        outcome = self.check_result(result, encoding_true)

        assert outcome == True

    def test_encoding_1(self, encoding_typeError_1):
        result = semanticCheck.encoding_check(sample_invalid_encodingType_1, extension)
    ...
    def test_encoding_3(self, encoding_typeError_2):
        result = semanticCheck.encoding_check(sample_invalid_encodingType_2, extension)
        outcome = self.check_result(result, encoding_typeError_2)

        assert outcome == True

    def test_webbased_entity(self, webbasedEntity_true):
        result = semanticCheck.webbased_entity_check(sample_invalid_referencing_missing, extension)
    ...
    def test_organization_entity(self, organizationEntity_true):
        result = semanticCheck.organization_check(sample_invalid_referencing_missing, extension)
    ...
    def test_organization_entity(self, organizationEntity_typeError):
        result = semanticCheck.organization_check(sample_invalid_organizationType, extension)
        outcome  = self.check_result(result, organizationEntity_typeError)

        assert outcome == True

    def test_contactInfo_entity(self, contactInfo_true):
        result = semanticCheck.contact_info_check(sample_invalid_referencing_missing, extension)
    ...
    def test_contactInfo_entity_2(self, contactInfo_typeError):
        result = semanticCheck.contact_info_check(sample_invalid_contactInfo, extension)
    ...
    def test_citation_entity_2(self, citation_referencingError):
        result = semanticCheck.citation_check(sample_invalid_citation_missing, extension)
        outcome  = self.check_result(result, citation_referencingError)

        assert outcome == True

    def test_citation_entity_3(self, citation_idError):
        result = semanticCheck.citation_check(sample_invalid_citationId, extension)
        outcome  = self.check_result(result, citation_idError)

        assert outcome == True  

    def test_publisher_entity(self, publisher_true):
        result = semanticCheck.publisher_check(sample_invalid_referencing_missing, extension)
    ...
    def test_publisher_entity_2(self, publisher_referencingError):
        result = semanticCheck.publisher_check(sample_invalid_publisher_referencing, extension)
        outcome  = self.check_result(result, publisher_referencingError)

        assert outcome == True

    def test_funder_entity(self, funder_true):
        result = semanticCheck.funder_check(sample_invalid_referencing_missing, extension)
    ...
    def test_licensing_entity(self, licensing_referencingError):
        result = semanticCheck.licensing_check(sample_invalid_referencing_missing, extension)
        outcome  = self.check_result(result, licensing_referencingError)

        assert outcome == True

    def test_licensing_entity_1(self, licensing_true):
        result = semanticCheck.licensing_check(sample_valid_1, extension)
        outcome  = self.check_result(result, licensing_true)

        assert outcome == True

    def test_licensing_entity_2(self, licensing_typeError):
        result = semanticCheck.licensing_check(sample_invalid_licenceType, extension)
    ...
    def test_places_entity(self, places_true):
        result = semanticCheck.places_check(sample_invalid_referencing_missing, extension)
    ...
    def test_time_entity(self, time_true):
        result = semanticCheck.time_check(sample_invalid_referencing_missing, extension)
    ...
    def test_workflow(self, workflow_true):
        result = semanticCheck.scripts_and_workflow_check(sample_invalid_referencing_missing, extension)
